...
local setup = {
  ...
  triggers_blacklist = {
    ...
    -- this is mostly relevant for key maps that start with a native binding most people should not need to change this
    i = { "j", "k" },
    v = { "j", "k" },
  },
}
...
local mappings = {
  ...
  t = {
    name = "Terminal",
    t = { "<cmd>ToggleTerm direction=float<cr>", "term" },
