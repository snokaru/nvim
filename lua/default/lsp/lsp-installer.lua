...
lsp_installer.on_server_ready(function(server)
	...
	if server.name == "jsonls" then
		local jsonls_opts = require("default.lsp.settings.jsonls")
	...
	if server.name == "pyright" then
		local pyright_opts = require("default.lsp.settings.pyright")
		opts = vim.tbl_deep_extend("force", pyright_opts, opts)
	end

	if server.name == "html" or server.name == "emmet_ls" then
		local html_opts = require("default.lsp.settings.html")
